...
function auto_tech:run()
    ...
    self:run_phase(function()
        ...
        self:run_phase(self.set_tech_order, "tech order setting (8/12)")
        self:run_phase(self.set_science_packs, "science packs setting (9/12)")
        self:run_phase(self.set_tech_unit, "tech cost setting (10/12)")
